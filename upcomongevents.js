...
// Obtener todas las categorías únicas de los eventos futuros
const categories = [...new Set(events.filter(event => new Date(event.date) > currentDate).map(event => event.category))];
...
// Filtrar y mostrar eventos futuros
